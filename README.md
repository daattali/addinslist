...
| namebrowser | scan all installed packages for names, search name to insert library(pkg) or pkg:: prefix | [namebrowser](https://github.com/dracodoc/namebrowser) | :x: | [dracodoc](https://github.com/dracodoc) |[screenshot and demo video](https://github.com/dracodoc/namebrowser) | |
