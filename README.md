...
| Merge data frames | Perform Inner,left,Right and Full Joins and create a new data frame  | [RStudioAddins](https://github.com/sarupurisailalith/RStudioAddins) | :x: | [sarupurisailalith](https://github.com/sarupurisailalith) | | |
| Convert Variable types | Create a new data frame after converting variable types  | [RStudioAddins](https://github.com/sarupurisailalith/RStudioAddins) | :x: | [sarupurisailalith](https://github.com/sarupurisailalith) | | |