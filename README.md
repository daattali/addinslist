...
|makeImport | parse R script to create importFrom and import calls to paste directly in roxygen or NAMESPACE | [YSmisc](https://github.com/yonicd/YSmisc) | :x: | [Jonathan Sidi](https://github.com/yonicd/YSmisc) |[Console Screenshot](https://raw.githubusercontent.com/yonicd/YSmisc/master/Miscellaneous/makeImport.png) | |
