...
| styler | RStudio Addin to provide non-invasive pretty-printing of R source code while adhering to the tidyverse formatting rules. | [styler](https://github.com/r-lib/styler) | :x: | [R infrastructure](https://github.com/r-lib) | | |
