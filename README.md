...
|sortLines | Sort selected lines in the editor with a number-smart algorithm. | [sortLines](https://github.com/dcomtois/RStudioAddInsDC) | :x: | [Dominic Comtois](http://statconseil.com) | | |
| makeImport | Parse an R script to create importFrom and import calls to paste directly in roxygen or NAMESPACE | [YSmisc](https://github.com/yonicd/YSmisc) | :x: | [Jonathan Sidi](https://github.com/yonicd/YSmisc) |[Console Screenshot](https://raw.githubusercontent.com/yonicd/YSmisc/master/Miscellaneous/makeImport.png) | |
